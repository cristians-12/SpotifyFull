    ...
    return (
        ...
        >
            ...
            <div className="rounded-xl w-48 h-48 overflow-hidden">
                <Image src={album.image} width={200} height={200} alt={album.title} className="" />
            </div>
            <h2 className="text-start mt-5 hover:underline hover:cursor-pointer font-bold">{album.title}</h2>
